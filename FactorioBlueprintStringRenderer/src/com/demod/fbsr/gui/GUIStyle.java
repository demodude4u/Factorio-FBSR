...
public final class GUIStyle {
	...
	public static GUISliceFeature FRAME_WHITE_INNER = GUISliceFeature.inner(DEFAULT_TILESET, //
			new GUIBox(446, 86, 17, 17), new GUISpacing(8, 8, 8, 8));
	public static GUISliceFeature FRAME_WHITE_OUTER = GUISliceFeature.outer(DEFAULT_TILESET, //
			new GUIBox(463, 86, 17, 17), new GUISpacing(8, 8, 8, 8));
	public static GUISliceFeature FRAME_WHITE_DARK_INNER = GUISliceFeature.inner(DEFAULT_TILESET, //
	...
	public static GUIPipeFeature DRAG_LINES_WHITE = GUIPipeFeature.dragLines(DEFAULT_TILESET,
